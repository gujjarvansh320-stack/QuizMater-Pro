...
//       // 👇 ADD THIS LINE TO SAVE REAL-TIME DATA FOR THE PROFILE PAGE 👇
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save real-time data for the profile page
      localStorage.setItem("user", JSON.stringify(data.user));

      // 👇 3. SHOW SUCCESS TOAST (Replaces the loading spinner)
      ...
      // 👇 4. SHOW ERROR TOAST (Replaces the ugly browser alert)
